...
func_paths = fullfile(pkg_path, {'run_decomp.m', 'sort_eigen.m'});
...
function [avg_ZSalience, pca_out, pca_main, img_dim] = pca_fmri(top_dir, output, pipe, filters, nboot)
	...
	pca_loo = struct('Salience',{NaN(nsub,1)},'pca',{NaN(nsub,1)}, 'ZSalience', {NaN(nsub,1)}, ...
						'VSalience', {NaN(nsub,1)}, 'pcs_Xo', {NaN(nsub,1)});
	parfor ii = 1:nsub
